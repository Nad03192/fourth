...
export default function FooterAll({ metas }) {
  ...
  return (
    <div >
      ...
      <div className="bg-[#FF4A4A] w-full">
        <footer className="w-full mx-auto dark:bg-gray-900 pt-5 sm:pt-20">
          <div className="pb-3 container mx-auto">
            ...
            <div className="grid grid-cols-2 p-4 sm:pb-10 sm:p-0 sm:grid-cols-6 gap-0 gap-y-3 sm:gap-y-10 items-start">
                ...
                <ul className="space-y-1">
                  {[
                    ...
                    <li key={index} className="relative flex items-center">
                      <a href={item.href} className="hover:text-gray-300 text-[16px] font-semibold">
                        {item.label}
                      </a>
                    </li>
                  ))}
              ...
              <div className="flex flex-col col-span-6 sm:col-span-2 text-white">
                <p className="text-md mb-5">Inquiries</p>
              ...
              <Link href="/" className="max-w-full md:mt-[-5px]">
                <div className="flex text-white text-md md:text-[20px] lg:text-[30px] font-bold max-w-[100%] overflow-hidden whitespace-nowrap">
              ...
              <div className="items-center space-x-5 flex flex-row justify-self-start">
                ...
                <a href="https://www.instagram.com/your-profile" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 50 50" className="hover:scale-110 hover:opacity-80 transition duration-200 ease-in-out fill-white text-white">
                    <path d="M 16 3 C 8.8324839 3 3 8.8324839 3 16 L 3 34 C 3 41.167516 8.8324839 47 16 47 L 34 47 C 41.167516 47 47 41.167516 47 34 L 47 16 C 47 8.8324839 41.167516 3 34 3 L 16 3 z M 16 5 L 34 5 C 40.086484 5 45 9.9135161 45 16 L 45 34 C 45 40.086484 40.086484 45 34 45 L 16 45 C 9.9135161 45 5 40.086484 5 34 L 5 16 C 5 9.9135161 9.9135161 5 16 5 z M 37 11 A 2 2 0 0 0 35 13 A 2 2 0 0 0 37 15 A 2 2 0 0 0 39 13 A 2 2 0 0 0 37 11 z M 25 14 C 18.936712 14 14 18.936712 14 25 C 14 31.063288 18.936712 36 25 36 C 31.063288 36 36 31.063288 36 25 C 36 18.936712 31.063288 14 25 14 z M 25 16 C 29.982407 16 34 20.017593 34 25 C 34 29.982407 29.982407 34 25 34 C 20.017593 34 16 29.982407 16 25 C 16 20.017593 20.017593 16 25 16 z" className="stroke-white stroke-2" />
                  </svg>
                </a>

                <a href="https://www.linkedin.com/in/your-profile" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <svg className="w-6 h-7 hover:scale-110 hover:opacity-80 transition duration-200 ease-in-out text-white" fill="currentColor" viewBox="0 0 24 24">
